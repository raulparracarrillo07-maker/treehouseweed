import { montarPuertaEdad } from "./age-gate.js?v=3";
import { montarIntro } from "./intro.js?v=3";
import { iniciarSmooth, revelar } from "./anim.js?v=3";
import { renderCasa, renderCuarto, renderDestacados, renderInfo } from "./ui-store.js?v=3";
import { carritoVacio, agregar, cambiarCantidad } from "./cart.js?v=3";
import { renderCarrito } from "./ui-cart.js?v=3";
import { construirMensaje, construirURL } from "./whatsapp.js?v=3";
